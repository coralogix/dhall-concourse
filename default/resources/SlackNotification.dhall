...
in  { version = {=} : SlackNotification.version.schema
    , params =
        { get = {=} : SlackNotification.params.get.schema
        , put =
              { text = None Text
              , text_file = None Text
              , attachments =
        ...
        , attachment =
            ...
            →   { fallback = _params.fallback
                ...
                , fields =
                    None
                      ( List
                          { title : Text, value : Text, short : Optional Bool }
                      )
                , image_url = None Text
                , thumb_url = None Text
                , footer = None Text
    ...
    , source =
        ...
        →   { url = _params.url
            ...
            , disable = None Bool
            , ca_certs = None (List { domain : Text, cert : Text })
            }

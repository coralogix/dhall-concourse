...
in  { version =
    ...
    , params =
        { get = { bump = None Text, pre = None Text } : Semver.params.get.schema
        , put =
        ...
        { drivers =
            ...
            , s3 =
                ...
                →   { driver = "s3"
                    , bucket = _params.bucket
                    , key = _params.key
                    , access_key_id = _params.access_key_id
                    , secret_access_key = _params.secret_access_key
            ...
            , swift =
                ...
                →   { driver = "swift"
                    , openstack =
                        ...
                        , item_name = _params.item_name
                        , region = _params.region
                        , identity_endpoint = _params.identity_endpoint
                        , username = None Text
                        , user_id = None Text
                        , password = None Text
                        , api_key = None Text

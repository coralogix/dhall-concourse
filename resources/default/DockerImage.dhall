let DockerImage = ../types/DockerImage.dhall

let name = "docker-image"

let repository = "concourse/docker-image-resource"

let type = "docker-image"
...
let get_params =
        { save = None Text, rootfs = None Text, skip_download = None Bool }
